...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Counters nested inside another animated element (e.g. a stat card)
  // won't themselves receive [data-anim], so watch them independently.
  document.querySelectorAll('[data-count]').forEach(el => {
    if (!el.dataset.anim) animObserver.observe(el);
  });
